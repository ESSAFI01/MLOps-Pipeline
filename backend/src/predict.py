...
def load_model(model_path='C:\Users\essaf\Desktop\MLopsTP\Mlpro\models\regressorfinal.pkl'):
    """
...
def predict_multiple(test_configs, model_data):
    ...
    for config in test_configs:
        ...
        results.append({
            ...
            'Estimated Price': f"{price:.0f} MAD"
        })
...
if __name__ == "__main__":
    ...
    test_configs = [
        {'name': 'Mercedes-Benz C Class', 'manufacturer': 'MERCEDES-BENZ', 'age': 5, 
         'kilometerage': 50000.0, 'engine': 'Petrol', 'transmission': 'Automatic'},
        {'name': 'Toyota Corolla', 'manufacturer': 'TOYOTA', 'age': 5, 
         'kilometerage': 50000.0, 'engine': 'Petrol', 'transmission': 'Manual'},
